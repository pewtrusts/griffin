 ...
 */
 ...
 /**
    modified 12/6/2019 John Osterman to allow app to pass in resolve function
    when all that is needed is the dataURL of the png, not the downloaded image
 */
'use strict';
(function (factory) {
